...
class TestExceptions(unittest.TestCase):
    def test_CustomException__exists_and_is_subclass_of_exception__true(self):
    ...
    def test_MockException__exists_and_is_subclass_of_exception__true(self):
    ...
    def test_DoorException__exists_and_is_subclass_of_exception__true(self):
    ...
    def test_ProgramAlreadyRunningException__exists_and_is_subclass_of_exception__true(self):
        self.assertTrue(hasattr(exceptions, "ProgramAlreadyRunningException"))
        self.assertTrue(issubclass(exceptions.ProgramAlreadyRunningException, exceptions.CustomException))

    def test_ProgramAlreadyRunningException__no_arguments__default_message_set(self):
        exception = exceptions.ProgramAlreadyRunningException()

        self.assertEqual(str(exception), "A program is already running.")
